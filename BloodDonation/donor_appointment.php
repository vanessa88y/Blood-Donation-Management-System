...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $appointment_location = 'Nyaduodo Dispensary'; // Fixed location
    ...
    if (isset($_POST['schedule'])) {
        ...
        $sql_schedule = "INSERT INTO appointments (user_id, role, appointment_date, location) 
                         VALUES ('$user_id', 'donor', '$appointment_date', '$appointment_location')";
...
// Query to retrieve the donor's appointments
$sql_appointments = "SELECT * FROM appointments WHERE user_id = '$user_id' AND role = 'donor' ORDER BY appointment_date DESC";
